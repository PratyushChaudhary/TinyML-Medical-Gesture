...
#define EI_CLASSIFIER_PROJECT_ID                 881836
#define EI_CLASSIFIER_PROJECT_OWNER              "praty7717"
#define EI_CLASSIFIER_PROJECT_NAME               "Medical_Gesture_TinyML"
#define EI_CLASSIFIER_PROJECT_DEPLOY_VERSION     1
#define EI_CLASSIFIER_NN_INPUT_FRAME_SIZE        234
...
#define EI_CLASSIFIER_FUSION_AXES_STRING         "ax0 + ay0 + az0 + gx0 + gy0 + gz0 + ax1 + ay1 + az1 + gx1 + gy1 + gz1 + ax2 + ay2 + az2 + gx2 + gy2 + gz2"
...
#define EI_CLASSIFIER_TFLITE_LARGEST_ARENA_SIZE     3558
