# TinyML-Medical-Gesture

# Edge Impulse library for Medical_Gesture_TinyML

This is a C++ library that lets you run the impulse for "Medical_Gesture_TinyML" (https://studio.edgeimpulse.com/studio/881836) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
